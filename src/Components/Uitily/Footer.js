                ...
                <Row className="d-flex justify-content-between align-items-center">
                    ...
                    <Col
                        ...
                        <div className="d-flex pt-3 mx-2">
                            <img width="20px" height="20px" src={phone} alt="phone-pic" />
                            <p className="footer-phone">0122455346356</p>
                        </div>
                        <div style={{ cursor: "pointer" }}>
                            <img width="20px" height="20px" src={facebook} alt="facebook-pic" />
                        </div>
                        <div style={{ cursor: "pointer" }}>
                            <img width="20px" height="20px" src={instagram} alt="instagram-pic" />
                        </div>
                        <div style={{ cursor: "pointer" }}>
                            <img width="20px" height="20px" src={twitter} alt="twitter-pic" />
                        </div>
                    </Col>
                </Row>
            </Container>
